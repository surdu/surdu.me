...
export default function Terms() {
  return (
    <Layout>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Nicu Surdu's website.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Nicu Surdu's website, accessible
            from{" "}
            <a
              href="https://surdu.me"
      ...
      <p>
        The informations presented on the Website reflect personal experiences
        and should not be taken as instrutions or manuals.
      </p>
      <p>
